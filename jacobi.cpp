...
int main()
{
    ...
    // Save results
    save_results(x, "temperature_jacobi.dat");
    save_centerlines(x, "T_centerline_H_jacobi.dat", "T_centerline_V_jacobi.dat");
    ...
    save_results(T_analytical, "temperature_analytical_jacobi.dat");
    ...
    ofstream res_file("residual_history_jacobi.dat");
